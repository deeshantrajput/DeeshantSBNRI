...
import com.deeshant.deeshantsbnri.di.component.DaggerViewHolderComponent
...
import com.deeshant.deeshantsbnri.utils.display.Toaster
...
abstract class BaseItemViewHolder<T : Any, VM : BaseItemViewModel<T>>(
    ...
    private fun buildViewHolderComponent() =
        DaggerViewHolderComponent
            .builder()
            .applicationComponent((itemView.context.applicationContext as SbnApplication).applicationComponent)
